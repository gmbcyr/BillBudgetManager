...
public class NotifUtil {
    ...
    /**
     * Create a random OnTimeNotificationFB POJO.
     */
    public static OnTimeNotificationFB getRandom(Context context) {
        OnTimeNotificationFB OnTimeNotificationFB = new OnTimeNotificationFB();
        ...
        OnTimeNotificationFB.setNom(getRandomName(random));
        OnTimeNotificationFB.setCh1(getRandomString(cities, random));
        OnTimeNotificationFB.setCh2(getRandomString(categories, random));
        /*OnTimeNotificationFB.setPhoto(getRandomImageUrl(random));
        OnTimeNotificationFB.setPrice(getRandomInt(prices, random));
        OnTimeNotificationFB.setNumRatings(random.nextInt(20));*/

        // Note: average rating intentionally not set

        return OnTimeNotificationFB;
    }
     ...
     */
    public static String getPriceString(OnTimeNotificationFB OnTimeNotificationFB) {
        return OnTimeNotificationFB.getMontantop()+"";
    }
