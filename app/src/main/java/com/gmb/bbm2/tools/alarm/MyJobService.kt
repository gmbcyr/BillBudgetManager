package com.gmb.bbm2.tools.alarm
...
import com.gmb.bbm2.AccueilBBMActivity
import com.gmb.bbm2.R
import com.gmb.bbm2.alarm.MyBufferedReceiver
import com.gmb.bbm2.alarm.MyBufferedReceiverForCancel
import com.gmb.bbm2.alarm.MyBufferedReceiverForEdit
import com.gmb.bbm2.tools.allstatic.DEFAULT_ID_ALARM
import com.gmb.bbm2.tools.firestore.MyFirestoreEditor
import com.gmb.bbm2.tools.firestore.MyFirestoreEditor.CALLER_EVENT_EDIT_ONE
...
class MyJobService : JobService() {
    ...
    private fun createNotification(messageBody: String?) {
        ...
        val intent = Intent(this, AccueilBBMActivity::class.java)
    ...
    fun sendNotification(bundle: JSONObject?, idStat: Long, idRem: Long, idAlarm: Int) {
        ...
        var intent = Intent(this, MyBufferedReceiver::class.java)
            ...
            if (1<2) {
                ...
                //Log.e("MyAlarmService","update alarm avec NOtifDejaSend->"+notifDejaSend);
                    ...
                    //Log.e("MyAlarmService","update alarm avec rem is notifMatch->"+rem.getIsnotifmatch());
                        ...
                        val intent2 = Intent(this, MyBufferedReceiver::class.java)
                        ...
                        val intent3 = Intent(this, MyBufferedReceiverForCancel::class.java)
    ...
    fun getIntentPrimary(intent: Intent, idStat: Long, idNotif: Long, idRem: Long, idAlarm: Int, bundle: JSONObject): Intent {
        ...
        val intent2 = Intent(this, MyBufferedReceiverForEdit::class.java)
        intent2.putExtra("js",bundle.toString())
        intent2.putExtra("isFromNotif", true)
        intent2.putExtra("idStat", idStat)
        intent2.putExtra("idAlarm", idAlarm)
