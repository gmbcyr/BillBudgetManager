...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(OnTimeNotificationFB.FIELD_DATE_OP);
    ...
    public String getSearchDescription(Context context) {
        ...
        if (price > 0) {
            desc.append(" for ");
            desc.append("<b>");
            desc.append(NotifUtil.getPriceString(price));
            desc.append("</b>");
        }
    ...
    public String getOrderDescription(Context context) {
        if (OnTimeNotificationFB.FIELD_CURRENT_STATE.equals(sortBy)) {
            return context.getString(R.string.sorted_by_price);
        } else if (OnTimeNotificationFB.FIELD_MONTANT_OP.equals(sortBy)) {
