 ...
 */
public abstract class MyFBadapterOld<VH extends RecyclerView.ViewHolder>
    ...
    public MyFBadapterOld(Query query) {
        mQuery = query;
    }
    ...
    public DocumentSnapshot getSnapshot(int index) {
        return (mSnapshots !=null && mSnapshots.size()>0)? mSnapshots.get(index):null;
    }

    public ArrayList<DocumentSnapshot> getSnapshot() {
        return mSnapshots;
    }
