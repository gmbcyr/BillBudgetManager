...
class MainTabActivity : AppCompatActivity(),AllListingFragment.OnListFragmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            val inten= Intent(this,BottomNavigationActivity::class.java);
            startActivity(inten);
        }
    ...
    inner class SectionsPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(position: Int): Fragment {
            ...
            if(position==0){
                return AllListingFragment.newInstance(1);
            }
